<template>
  <main>
    <div class="container">
      ...
      <head-table />
      <div class="chart-row">
        <app-chart :type="'bar'" :title="'Заказы по дням недели'" :label="'Динамика продаж'" />
        <app-chart :type="'bar'" :title="'Заказы по часам (2 часа)'" :label="'Динамика продаж'" />
      </div>
...
import HeadTable from "@/components/UI/head-table.vue";
export default {
  data(){
     return{
       navActive:0,
  ...
  components: {HeadTable, AppSwitch , AppTitle, BreadCrumbs ,FiltersBlock  , MainHead , AppChart},
};
</script>
