    ...
    <div class="container">
      ...
      <div class="block-setting">
        <app-title
            ...
            tag="h5"
        >
          Редактирование аккаунта сотркдника
        </app-title>
        <div class="grid">
          <app-input
              :placeholder="'ФИО '"
        ...
        <app-button  :align="'right'" :text="'Сохранить'" :type="2"/>
      </div>
      ...
      <div class="block-setting">
        ...
        <div class="password-requirements">
          <div>
            ...
            <p>
              Пожалуйста, следуйте этому руководству для создания надежного пароля:
            </p>
            <ul>
              <li>Один специальный символ</li>
              <li>Минимум 6 знаков</li>
              <li>Один номер (рекомендуется 2)</li>
              <li>Меняйте его чаще</li>
            </ul>
          </div>
          <app-button  :align="'right'" :text="'Изменить пароль'" :type="2"/>
        </div>
      </div>

      <div class="row-btns" >
        <app-button :text="'Применить'" :type="2"></app-button>
        <app-button :text="'Очистить'" :type="3"></app-button>
      </div>
...
export default {
  ...
  components: {AppButton, AppInput, AppTitle, BreadCrumbs , MainHead},
};
</script>
